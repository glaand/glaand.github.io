...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/src/js/main/navigation.js");
/******/ })
/************************************************************************/
/******/ ({
...
jQuery(document).ready(function () {
  ...
  var menuLi = jQuery(menu).find('>li');

  for (var i = 0; i < menuLi.length; i++) {
    var subMenu = jQuery(menuLi[i]).find('>ul');

    if (subMenu.length) {
      jQuery(menuLi[i]).find('>a').after("<span class='sub-menu-click'></span>");
      var submenuLi = jQuery(subMenu).find('>li');

      for (var j = 0; j < submenuLi.length; j++) {
        var subsubMenu = jQuery(submenuLi[j]).find('>ul');

        if (subsubMenu.length) {
          jQuery(submenuLi[j]).find('>a').after("<span class='sub-menu-click'></span>");
        }
      }
    }
  ...
  jQuery('.sub-menu-click').on('click', function () {
